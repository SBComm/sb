...
(function($){
	...
	$.extend(SocialStreamObject.prototype, {
		...
		create: function(el, options) {
			...
			this.defaults = {
				feeds: {
					...
					twitter: {
						...
						url: 'http://www.stonybrook.edu/social/twitter.php',
						icon: 'twitter.png',
						iconFont: 'twitter'
					},
					google: {
			...
			$(el).addClass(this.o.container).append('<div class="'+this.o.content+'"><ul class="'+this.o.cstream+'"></ul></div><div class="bottom-fade"><span class="button"><div class="sbu-link sbu-cta sbu-cta-1 sbu-cta-1a">View more posts</div></span></div>');
