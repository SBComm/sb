...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$second_level    = 'additional-programs';
			$page_title_sub  = 'Additional Programs';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Stony Brook ' . $page_title_sub;
		    $og_description  = 'Stony Brook University offers a variety of experiences and programs that challenge, inspire and sustain our diverse range of students.';
		    $og_url          = 'http://www.stonybrook.edu/academics/additional-programs';
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/academics/additional-programs.php');
							?>
						<!-- </content> -->
