<?php
	...
	if($include_head_code==1) {
		...
		<link href="//www.stonybrook.edu/css/new-brand.css" rel="stylesheet">
		<link href="//www.stonybrook.edu/css/nav.css" rel="stylesheet">
		<?php
		if($second_level!='') { ?>
			<link href='//www.stonybrook.edu/css/second-level.css' rel="stylesheet">
			<link href='//www.stonybrook.edu/css/second-level/<?php echo $second_level; ?>.css' rel="stylesheet">
			<link href="//www.stonybrook.edu/css/second-level/<?php echo $second_level; ?>-inside.css" rel="stylesheet">
		<?php } ?>
