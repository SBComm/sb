        ...
        <div class="sbu-sub-wrapper">
            ...
            <div class="header-container">
                <div class="nav-elements-container">
                    ...
                    <!-- </quick-nav> -->
                    <!-- <more-nav> -->
                                            <nav class="more-nav closed clearfix">
                        <ul class="no-pad-wrapper border-box clearfix">
                            <li class="clearfix">
                    ...
                    <div class="logo-container page-cat-sub clearfix border-box">
                        <header class="no-pad-wrapper">
                            <div class="logo-wrapper">
                                <div class="logo"><a href="http://www.stonybrook.edu/"><img src="//www.stonybrook.edu/sb/img/stony-brook-university-logo.jpg"></a></div>
                                <h1 class="site-name serif"><a href="">Calendar</a></h1>
                            </div>
                        </header>
                    </div>
                <!-- </logo-container> -->
            ...
            <div class="main-nav-container clearfix">
                <!-- <site-nav> -->
                <nav class="site-nav default border-box clearfix">
                        <div class="no-pad-wrapper clearfix">
                            ...
                            <ul class="main-nav-list border-box hide-accessible-mobile clearfix">
                                ...
                                <li class="clearfix medicine larger">
                            ...
                            <div class="search-container default clearfix border-box">
                                <form class="search-wrapper" action="https://www.stonybrook.edu/search">
