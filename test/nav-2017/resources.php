...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$second_level    = 'resources';
			$page_title_sub  = 'Academic Resources';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Stony Brook ' . $page_title_sub;
		    $og_description  = 'Academic resources at Stony Brook University including academic advising, tutoring and the writing center.';
		    $og_url          = 'http://www.stonybrook.edu/academics/resources/';
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/academics/resources.php');
							?>
						<!-- </content> -->
