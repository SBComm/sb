...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
		    ...
		    $og_description  = 'Here at Stony Brook, you’ll discover the advantages of a major university — excellence in education, an active research environment, and one of the best university-teaching hospitals in the region.';
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/admissions/index.php');
							?>
						<!-- </content> -->
