...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$second_level    = 'news-and-events';
			$page_title_sub  = 'News and Events';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Read about the exceptional people at Stony Brook, learn about their imaginative discoveries and see all the opportunities available at our world-class research University.';
		    $og_url          = 'http://www.stonybrook.edu/about/news-and-events/';
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/about/news-and-events.php');
							?>
						<!-- </content> -->
