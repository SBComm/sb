...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$second_level    = 'fast-facts';
			$page_title_sub  = 'Fast Facts';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Stony Brook ' . $page_title_sub;
		    $og_description  = 'General facts, university rankings, tuition and fees, financial aid and student body stats, and more.';
		    $og_url          = 'http://www.stonybrook.edu/about/facts-and-rankings/';
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/about/fast-facts.php');
							?>
						<!-- </content> -->
