...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$page_title_sub  = 'Athletics';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Stony Brook ' . $page_title_sub;
		    $og_description  = 'Stony Brook University has grown to become one of only four University Center campuses in the SUNY system with more than 25,200 students and faculty that have earned prestigious awards, including the Nobel Prize, Pulitzer Prize, Indianapolis Prize for animal conservation, Abel Prize and the inaugural Breakthrough Prize in Mathematics.';
		    $og_url          = 'http://www.stonybrook.edu/athletics/';
		    $main_nav_selected_tab = 7;
		            ...
		            <div class="main clearfix">
		                ...
		                <!-- <content> -->
							<?php 
								...
								include('/user/commcms/www/_second-level/athletics/index.php');
							?>
						<!-- </content> -->
