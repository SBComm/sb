...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!--site variables-->
		<?php
			...
			$second_level    = 'campus-safety';
			$page_title_sub  = 'Campus Safety';
			$page_title_full = $page_title . (isset($page_title_sub) && $page_title_sub!='' ? ' | ' . $page_title_sub : '');

		    $og_title        = 'Stony Brook ' . $page_title_sub;
		    $og_description  = 'Campus Safety provides resources and information to keep you safe on campus.';
		    $og_url          = 'http://www.stonybrook.edu/campus-safety';

		    $page_to_top_link = true;
		    $page_to_top_loc  = 'tabs-wrapper';
