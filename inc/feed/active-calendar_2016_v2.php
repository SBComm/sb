<?php
    ...
    foreach ($rssFeed->channel->item as $item){
        ...
        if($start == 0) {
            ...
            $eventMonthFull = $eventDate->format('F');
            ...
            if ($proceed) {
                ...
                $html .= '<div class="eventDate" data-test="1" aria-label="'.$eventMonthFull.' '.$eventDay.', '.$eventYear.'"><span class="eventDate_day">'.$eventDay.'</span><span class="eventDate_month">'.$eventMonth.'</span></div>';
