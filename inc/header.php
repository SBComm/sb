        ...
        <?php if($is_production_environment) { ?>
            ...
            <script>
                (function(f,b,g){
                    ...
                    f._hjSettings={hjid:7729, hjsv:2};
                    function ls(){f.hj.documentHtml=b.documentElement.outerHTML;c=b.createElement("script");c.async=1;c.src="//static.hotjar.com/c/hotjar-7729.js?sv=2";b.getElementsByTagName("head")[0].appendChild(c);}
