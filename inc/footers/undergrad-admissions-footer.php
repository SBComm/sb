                <footer class="site-footer clearfix">
                    <nav class="wrapper">
                         <div class="clearfix">
                         	...
                         	<div class="col col-3 equal-col">
                                   <span class="address">
                                        <span class="serif-italic">Mailing Address</span>
                                        Stony Brook University<br />
                                        UG Processing<br />
                                        279 Broadway<br />
                                        Albany, NY 12204-2755<br />
                                        <span class="phone nowrap">Fax: (631) 632-9898</span>
                                   </span>
                              </div>
                         </div>
                         <div class="col col-4 clearfix">
                              <span class="codes clearfix">
                                   <span class="serif-italic">University Codes</span>
