<div class="rounded-image-buttons clearfix">
    ...
    <?php } else if($selected_sub_nav!="school-of-dental-medicine") { ?>
    ...
    <?php } else if($selected_sub_nav!="school-of-social-welfare") { ?>
    ...
    <?php } else if($selected_sub_nav!="school-of-nursing") { ?>
    ...
    <?php } else if($selected_sub_nav!="school-of-health-technology-management") { ?>
    <a class="htm<?php if($selected_sub_nav=="school-of-health-technology-management") { ?> selected<?php } ?>" href="alumni/chapters/school-of-health-technology-management"><div class="label"><span>School of</span> Health Technology Management</div></a>
    <?php } ?>
</div>