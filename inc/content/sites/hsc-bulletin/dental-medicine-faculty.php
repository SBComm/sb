...
<ul id="tabbed-nav">
    ...
    <li class="selected"><a href="hsc-bulletin/schools/dental-medicine/faculty">Faculty</a></li>
  </ul>
  ...
  <section>
    ...
    <table class="responsive faculty">
      <thead>
      <tr>
        <th>Name</th>
        <th>Title</th>
      ...
      <tbody>
      <tr>
        <td>Lee Ann Xippolitos</td>
        <td>Dean</td>
      </tr>
      <tr>
        <td>Lori Escallier</td>
