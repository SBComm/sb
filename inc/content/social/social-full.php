        ...
        <div id="wrapper">
            <div id="container"> 
                <style type="text/css">
                    ...
                    #social-stream { max-height: 2000px; }
                </style>
                <h1>We&#8217;re <span class="darker">Social</span></h1>
                <div class="subtitle sbu-text-shadow">Get the latest in <br />Stony Brook University <br />social media!</div>
                <div class="subtitle sbu-text-shadow"><em class="fa fa-globe"></em> <span class="red">stonybrook.edu/social</span></div>
                <div id="wall">
                    ...
                    <ul class="social-channels-main clearfix">
                        ...
                        <li class="social-other-item sbu-border-bottom">
                            ...
                            <div class="social-channels-container">
                                ...
                                <a href="https://twitter.com/GradSBU" target="_blank"><i class="fa fa-twitter"></i></a>
