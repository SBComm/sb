<article class="freshman-apply">
    ...
    <section class="clearfix inside-content main-inside-content white-background">
        <div class="border-box wrapper clearfix">
            ...
            <div class="content application-details clearfix">
                <div class="inner-wrapper">
                    <h4>Option 2: The SUNY Application</h4>
            ...
            <div class="content clearfix application-items">
                <h4>Documents to Submit in Addition to Your Application</h4>
            ...
            <div class="content clearfix">
                ...
                <div class="drop-accordion drop-accordion-1 clearfix">
                    ...
                    <div class="item">
                        <div class="tab">
                            <span class="label"><i class="fa fa-plus-circle"></i>Home-Schooled Applicants</span>
                        </div>
                        <div class="content clearfix hide-accessible">
                            <div class="content-wrap">
                    ...
                    <div class="item">
                        <div class="tab">
                            <span class="label"><i class="fa fa-plus-circle"></i>Nursing</span>
                        </div>
                        <div class="content clearfix hide-accessible">
                            <div class="content-wrap">
                    ...
                    <div class="item">
                        <div class="tab">
                            <span class="label"><i class="fa fa-plus-circle"></i>Social Work</span>
                        </div>
                        <div class="content clearfix hide-accessible">
                            <div class="content-wrap">
