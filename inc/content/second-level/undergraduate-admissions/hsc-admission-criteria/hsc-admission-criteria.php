<article>
    ...
    <section class="clearfix inside-content main-inside-content two-col white-background">
        <div class="border-box wrapper clearfix">
            <h3>HSC Admission Requirements &amp; Application Procedures</h3>
            <div class="content clearfix">
                <p>These majors are upper-division and require completion of 57 college credits and specific courses/grade prerequisites.</p>
