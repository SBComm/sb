<div class="section-title">
    <a href="undergraduate-admissions/apply/international"><h2>international</h2></a>
</div>
...
<nav class="section-nav hide-accessible-mobile-960">
	<a <?php if($selected_sub_nav==1) { ?>class="selected" <?php } ?>href="undergraduate-admissions/apply/international">Welcome</a>
