    ...
    <section class="clearfix inside-content main-inside-content two-col white-background">
        <div class="border-box wrapper clearfix">
            ...
            <div class="content col-2">
                ...
                <p>If you have earned fewer than 24 credits at the time of application, your high school transcripts and SAT scores must also be submitted (only students with strong secondary school credentials will be considered for admission).</p>
            ...
            <div class="content col-2">
                ...
                <div class="drop-accordion drop-accordion-1">
                    ...
                    <div class="item">
                        ...
                        <div class="content clearfix hide-accessible">
                            <div class="content-wrap">
                                <p>Acceptance into the program requires an application process involving reference letters, a personal statement, and an interview. Applications are available through the <a class="external-link" href="http://www.pharm.stonybrook.edu/Undergraduate%20Program/application" target="_blank">Undergraduate Pharmacology department</a>.</p>
                            </div>
                        </div>
                    </div>
