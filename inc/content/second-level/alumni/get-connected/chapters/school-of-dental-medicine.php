            ...
            <div class="content">
                <div class="border-box whole intro-letter">
                    ...
                    <div id="letter" class="continue-reading-target hide-accessible">
                        <p>We look forward to seeing you at a future event soon, and most of all we look forward to welcoming you back to Stony Brook in the coming months for Homecoming on Saturday, October 17, 2015 and in Manhattan at our annual Greater New York Dental Meeting Alumni Reception on Tuesday, December 1, 2015.  We hope to see you all soon.</p>
                        <p>If you have any questions or comments feel free to contact Kristin 631-632-6130 or at kristin.matthews@stonybrook.edu or Dr. Kilimitzoglou at dk@esidental.com.</p>
                ...
                <div class="border-box whole news-and-events">
                    ...
                    <div class="border-box whole clearfix section-border-top pad-bottom">
                        <div class="border-box one-half padding-box">
                            ...
                            <div class="drop-accordion drop-accordion-1 clearfix">
                                ...
                                <div class="item">
                                    <div class="tab">
                                        <span class="label"><i class="fa fa-plus-circle"></i>Dr. John Rose (20040</span>
                                    </div>
                                    <div class="content clearfix hide-accessible">
                                        <div class="content-wrap">
                                            <p>
                                                <img class="inline-with-copy" src="img/alumni/board/rose.jpg" alt="Portrait of John Rose" />
                                                <strong>Dr. John Rose (20040</strong><br />
                                                Vice President<br />
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="tab">
                                        <span class="label"><i class="fa fa-plus-circle"></i>Debra Oreste,  1996</span>
                                    </div>
                                    <div class="content clearfix hide-accessible">
                                        <div class="content-wrap">
                                            <p>
                                                <strong>Debra Oreste,  1996</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="border-box whole clearfix section-border-top give-back">
                        ...
                        <div class="two-third">
                            ...
                            <p><a href="#" target="_blank">Dental Graduate Alumni Activity Fund</a>: To help support SDM alumni chapter activities and initiatives such as the mentor program</p>
                            <p><a href="#" target="_blank">Dean's Fund for the Future</a>: To help support teaching, special projects, equipment, research endeavors, patient care and service initiatives</p>
                            <p><a href="#" target="_blank">SDM Alumni Award of Excellence</a>: To further support an annual award given each year to a graduating dental student who has demonstrated leadership and a vision for the future of the School of Dental Medicine</p>
                            <p><a href="#" target="_blank">International Dental Outreach Fund</a>: To provide funding to support the purchase of supplies, equipment and travel costs for students and faculty to travel abroad to provide dental care to those most in need</p>
    ...
    <section class="clearfix inside-content main-inside-content som-links simple-buttons back-dark-red-crossed">
        <div class="border-box wrapper">
            <div class="btn-wrapper clearfix">
                ...
                <a class="simple-button arrow-after" href="http://dentistry.stonybrookmedicine.edu/dental/coned/upcoming-ce-courses">Continuing Education</a>
            </div>
