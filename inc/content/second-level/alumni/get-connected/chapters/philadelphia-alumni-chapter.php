    ...
    <section class="clearfix inside-content main-inside-content white-background">
        <div class="border-box wrapper clearfix">
            <div class="border-box whole">
                <h3 class="serif">Philadelphia Alumni Chapter</h3>
            </div>
            <div class="content">
                <div class="border-box one-third equal-height-col">
                    <nav class="sidebar-star-nav clearfix">
                        <?php
                            $selected_sub_nav = "philadelphia-alumni-chapter";
                        ...
                        <div class="one-half">
                            ...
                            <div class="activities-links">
                                <?php
                                    ...
                                    $rss   = "http://sb.cc.stonybrook.edu/happenings/category/philadelphia-chapter/feed/";
                                    $count = 7;
                                    $end = 7;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://sb.cc.stonybrook.edu/happenings/category/philadelphia-chapter" target="_blank">Read More News</a>
                        </div>
                        <div class="one-half">
