    ...
    <section class="clearfix inside-content main-inside-content white-background">
        <div class="border-box wrapper clearfix">
            <div class="border-box whole">
                <h3 class="serif">San Diego Alumni Chapter</h3>
            </div>
            <div class="content">
                        ...
                        <div class="one-half">
                            ...
                            <div class="activities-links">
                                <?php
                                    ...
                                    $rss   = "http://sb.cc.stonybrook.edu/happenings/category/san-diego-chapter/feed/";
                                    $count = 7;
                                    $end = 7;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://sb.cc.stonybrook.edu/happenings/category/san-diego-chapter" target="_blank">Read More News</a>
                        </div>
                        <div class="one-half">
