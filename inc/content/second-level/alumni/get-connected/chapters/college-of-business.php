<article class="get-connected alumni-chapter cob">
                ...
                <div class="border-box two-third">
                        ...
                        <div class="one-half">
                            ...
                            <div class="activities-links">
                                <?php
                                    ...
                                    $rss   = "http://sb.cc.stonybrook.edu/happenings/category/college-of-business-alumni/feed/";
                                    $count = 7;
                                    $end = 7;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://sb.cc.stonybrook.edu/happenings/category/college-of-business-alumni" target="_blank">Read More News</a>
                        </div>
                        <div class="one-half">
                            ...
                            <div class="news-feed">
                                <?php
                                    ...
                                    $rss   = "http://calendar.activedatax.com/stonybrook/RSSSyndicator.aspx?category=8-48";
                                    $count = 4;
                                    $end = 4;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://calendar.activedatax.com/stonybrook/default.aspx?type=&amp;view=Category&amp;category=8-48&amp;numdays=180" target="_blank">View All Events</a>
                        </div>
                    </div>
                    ...
                    <div class="whole event-gallery flickr-gallery clearfix" data-flickr-id="72157659517976382">
                        <div class="border-box inside-content">
                            ...
                            <p><a class="sbu-outline-button sbu-outline-button--red arrow-after" href="https://www.flickr.com/photos/sbuadvancement/sets/72157659517976382" target="_blank">View on Flickr</a> <a class="sbu-outline-button sbu-outline-button--on-red arrow-after" href="mailto:alumni@stonybrook.edu" target="_blank">Submit Your Photos</a></p>
                        </div>
                    </div>
                </div>
            </div>
