                        ...
                        <div class="one-half">
                            ...
                            <div class="activities-links">
                                <?php
                                    ...
                                    $rss   = "http://sb.cc.stonybrook.edu/happenings/category/public-policy-network/feed/";
                                    $count = 7;
                                    $end = 7;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://sb.cc.stonybrook.edu/happenings/category/public-policy-network" target="_blank">Read More News</a>
                        </div>
                        <div class="one-half">
                            ...
                            <div class="news-feed">
                                <?php
                                    ...
                                    $rss   = "http://calendar.activedatax.com/stonybrook/RSSSyndicator.aspx?category=8-53";
                                    $count = 4;
                                    $end = 4;
                            ...
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://calendar.activedatax.com/stonybrook/default.aspx?type=&amp;view=Category&amp;category=8-53&amp;numdays=180" target="_blank">View All Events</a>
                        </div>
                    </div>
                    <div class="whole activities-and-calendar clearfix">
                        <h5 class="on-red">Links and Resources</h5>
                        <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="https://www.linkedin.com/grps?gid=8109128" target="_blank">View on LinkedIn</a>
                    </div>
                    <div class="whole event-gallery flickr-gallery clearfix" data-flickr-id="72157658880119159">
                        <div class="border-box inside-content">
                            ...
                            <p><a class="sbu-outline-button sbu-outline-button--red arrow-after" href="https://www.flickr.com/photos/sbuadvancement/sets/72157658880119159" target="_blank">View on Flickr</a> <a class="sbu-outline-button sbu-outline-button--on-red arrow-after" href="#" target="_blank">Submit Your Photos</a></p>
                        </div>
                    </div>
                </div>
            </div>
