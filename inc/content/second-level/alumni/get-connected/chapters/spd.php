<article class="get-connected alumni-chapter">
    ...
    <section class="clearfix inside-content main-inside-content white-background">
        <div class="border-box wrapper clearfix">
            <div class="border-box whole">
                <h3 class="serif">School of Professional Development</h3>
            </div>
            <div class="content">
                ...
                <div class="border-box two-third equal-height-col">
                    ...
                    <p>For more information, select a chapter that best fits you.</p>
                        ...
                        <div class="one-half">
                            ...
                            <div class="news-feed">
                                <?php
                                    ...
                                    $count = 4;
                                    $end = 4;
                                    $no_results_text = 'Hm... It seems that there are no events scheduled for this chapter at the moment. Check back soon as we\'re always adding more, or <a href="http://calendar.activedatax.com/stonybrook/default.aspx?type=&view=Category&category=8-0">view all alumni events</a>.';
                                    include($path . $file);
                                ?>
                            </div>
                            <a class="sbu-outline-button sbu-outline-button--red arrow-after" href="http://calendar.activedatax.com/stonybrook/default.aspx?type=&amp;view=Category&amp;category=8-47" target="_blank">View All Events</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="event-gallery flickr-gallery clearfix" data-flickr-id="72157649295457517">
        <div class="border-box wrapper inside-content">
            ...
            <p><a class="sbu-outline-button sbu-outline-button--red arrow-after" href="#" target="_blank">View More Photos</a> <a class="sbu-outline-button sbu-outline-button--on-red arrow-after" href="#" target="_blank">Submit Your Photos</a></p>
        </div>
    </section>
