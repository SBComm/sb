...
<li<?php if($selected_sub_nav=="founders-alumni-group") { ?> class="selected"<?php } ?>><a href="alumni/chapters/founders-alumni-group">The Founders Alumni Group</a></li>
<li<?php if($selected_sub_nav=="lgbtq-alumni-group") { ?> class="selected"<?php } ?>><a href="alumni/chapters/lgbtq-alumni-group">LGBTQ Alumni Group </a></li>
<li<?php if($selected_sub_nav=="student-ambassador-alumni-network") { ?> class="selected"<?php } ?>><a href="alumni/chapters/student-ambassador-alumni-network">Student Ambassador Alumni Network</a></li>
<li<?php if($selected_sub_nav=="public-policy-alumni-network") { ?> class="selected"<?php } ?>><a href="alumni/chapters/public-policy-alumni-network">Public Policy Alumni Network</a></li>

<li<?php if($selected_sub_nav=="school-of-medicine") { ?> class="selected"<?php } ?>><a href="alumni/chapters/school-of-medicine">School of Medicine</a></li>
<li<?php if($selected_sub_nav=="school-of-dental-medicine") { ?> class="selected"<?php } ?>><a href="alumni/chapters/school-of-dental-medicine">School of Dental Medicine</a></li>
...
<li<?php if($selected_sub_nav=="denver-alumni-chapter") { ?> class="selected"<?php } ?>><a class="coming-soon" href="alumni/chapters/denver-alumni-chapter ">Denver Alumni Chapter </a></li>
<li<?php if($selected_sub_nav=="los-angeles-alumni") { ?> class="selected"<?php } ?>><a class="coming-soon" href="alumni/chapters/los-angeles-alumni-chapter">Los Angeles Alumni Chapter</a></li>
<li<?php if($selected_sub_nav=="phoenix-alumni-chapter") { ?> class="selected"<?php } ?>><a class="coming-soon" href="alumni/chapters/phoenix-alumni-chapter">Phoenix Alumni Chapter</a></li>
<li<?php if($selected_sub_nav=="philadelphia-alumni-chapter") { ?> class="selected"<?php } ?>><a class="coming-soon" href="alumni/chapters/philadelphia-alumni-chapter">Philadelphia Alumni Chapter</a></li>
<li<?php if($selected_sub_nav=="tucson-alumni-chapter") { ?> class="selected"<?php } ?>><a class="coming-soon" href="alumni/chapters/tucson-alumni-chapter">Tucson Alumni Chapter</a></li>-->