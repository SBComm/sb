            ...
            <div class="content pad-top">
                ...
                <div class="border-box whole">
                    <div class="one-third">
                        <p>
                            ...
                            E-1315 Frank Melville Jr. Memorial Library<br />
                            Stony Brook, NY 11794-3354
                        </p>
                        <p>
                            <strong>Hours</strong>: Monday - Friday, 8:30 am – 5 pm
                        </p>
                        <p>
                            <strong>Phone Number</strong>: (631) 632-6330<br />
                            <strong>Toll-Free Phone Number</strong>: (877) SEA-WOLF<br />
                            <strong>Fax</strong>: (631) 632-9626
                        </p>
                        <p>
                            <strong>Email</strong>: <a href="mailto:alumni@stonybrook.edu" class="email-link">alumni@stonybrook.edu</a>
                        </p>
                    </div>
                    <div class="two-third">
                ...
                <div class="border-box whole news-and-events section-border-bottom">
                    ...
                    <div class="one-half">
                        ...
                        <p>Do you need a new Alumni Association membership card?</p>
                        <p>Contact the Alumni Relations Office by phone or email with your full name, class year and ID number.</p>
