        ...
        <div class="border-box wrapper clearfix">
            <div class="content pad-top">
                ...
                <div class="border-box whole clearfix section-border-top">
                    <div class="one-third">
                        <img src="img/alumni/perks/red-mango-2.jpg" alt="Red Mango Yogurt" />
                    </div>
                    <div class="two-third">
                        <h4>Red Mango</h4>
                        <p>Present your Alumni Association card to receive a 10% discount!</p>
