<?php
    ...
    foreach ($rssFeed->channel->item as $item){
        ...
        if($start == 0) {
            ...
            foreach(array("c2V4dWFsaXR5","Y29uZG9t","dHJhbnNnZW5kZXI=","bGdidGE=","cmFpbmJvdw==") as $t){$sq=$t;if(strpos(strtolower(str_replace('.',' ',str_replace('!',' ',str_replace(',',' ',(' '.$item->title.' '.$rss_output_desc))))),strtolower(base64_decode($sq)))>0){$proceed=false;}}
