<article class="ghosted-campus">
    <section class="transparent-background page-title">
        <div class="wrapper border-box">
            <h1 class="serif"><a href="faculty-staff/">For Faculty &amp; Staff</a></h1>
        </div>
    </section>
    ...
    <section class="wrapper title-link-box-wrapper arrow-above arrow-below arrow-below-white">
        <div class="border-box clearfix title-link-box-container inside-content">
            <div class="title-link-box-1 left-link-box clearfix">
                <h2 class="red medium-title-3">Faculty &amp; Staff Resources</h2>
    ...
    <section class="activities-and-calendar inside-content arrow-below arrow-below-black">
        <div class="black-opac-cover">
            <div class="border-box wrapper clearfix">
                ...
                <h3 class="medium-title-2 white">Check out what's happening!</h3>
             </div>
            <div class="border-box wrapper clearfix">
