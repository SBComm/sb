<article>
    ...
    <section id="winter-courses" class="clearfix inside-content alt-headers wrapper search-results-wrapper">
        ...
        <?php if($show_Online) { ?>
            <div class="content alert-message alert-message-green clearfix">
                <p>What is required to be a successful online student? <a class="external-link" href="http://www.stonybrook.edu/commcms/winter/online.html" target="_blank">Read more...</a></p>
            </div>
    ...
    <?php
        $file = "winter-session/widgets/course-circles.php";
        include($path . $content . $secLv . $file);
    ?>
