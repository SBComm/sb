    ...
    <section class="clearfix inside-content main-inside-content alt-headers two-col white-background overflow-auto">
        <div class="border-box wrapper clearfix">
            <div class="content">
                ...
                <p>Since TAP, Pell Grant, and the Stafford Loan programs have award limits which may not be exceeded, applicants should check with the Office of Student Financial Services to understand how summer awards may affect future eligibility.</p>
