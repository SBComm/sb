                    ...
                    <div class="item">
                        ...
                        <div class="content clearfix open">
                            <div class="content-wrap">
                                ...
                                <a href="http://career.stonybrook.edu/" title="Handshake" target="_blank">Handshake</a>
            ...
            <div class="for-students-promo clearfix">
                <div class="video-promo-wrapper">
                    <div class="videoWrapper">
                        <iframe width="560" height="349" src="http://www.youtube.com/embed/5qokB1LmIR0?controls=1&showinfo=1&rel=0&modestbranding=1" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="video-caption content">
                        <strong>Featured Video:</strong> Check out the highlights from this year's Roth Regatta!
                    </div>
                </div>
    ...
    <section class="activities-and-calendar inside-content arrow-below arrow-below-black">
        <div class="black-opac-cover">
            <div class="border-box wrapper clearfix">
                ...
                <h3 class="medium-title-2 white">Check out what's happening in SB Life!</h3>
             </div>
            <div class="border-box wrapper clearfix">
