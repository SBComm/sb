    ...
    <div class="border-box wrapper clearfix">
        ...
        <div class="content clearfix">
            ...
            <div class="key-icons pad-top" data-filter-input-id="live-filter-search-1">
                ...
                <div class="key-icons--item do-live-filter-search-term" tabindex="0" data-live-filter-term="Secondary Teacher Education"><span class="key-icons--icon key-icons--icon_purple">S</span> = Secondary Teacher Education</div>
            ...
            <div id="live-filter-list-1" class="three-col-list-wrapper searchable major-minor-badges major-minor-badges--wider-badges" data-search-id="course-list">
                ...
                <?php
                    ...
                    include('/user/far-beyond/www/sb/inc/scripts/get-academics-programs_undergrad.php');
                ?>
